        ...
        <>
            <Grid container spacing={2} flexWrap="wrap" padding={2}>
                <Grid item xs={12} md={3}>
                    ...
                    <Box sx={{display:'flex',flexDirection:'column',justifyContent:'center',alignItems:'center',border:`1px solid ${theme.palette.liteGray}`}} >
                        <Box sx={{display:'flex',justifyContent:'center',alignItems:'center',width:'100%',backgroundColor:'lightPink',p:2,borderBottom:`1px solid ${theme.palette.liteGray}`}}>
