                ...
                <Box p={1}>
                            ...
                            >
                                <Box sx={{
                                    ...
                                    <Box sx={{
                                        ...
                                        <img src={template.img.src} alt={template.dec}
                                             style={{
                                                 width: "100%",
                                                 height: "100%",
                                                 objectFit: 'contain',
                    ...
                    <Modal open={open} onClose={handleClose}
                        ...
                        <Box sx={{
                            ...
                            {selectedTemplate && (
                                <>
                                    <Typography sx={{fontSize: "22px", fontWeight: 600, color: "sidebarHover"}}>Replace
                                        diagram?</Typography>
                                    <Typography sx={{fontSize: "16px", color: "sidebarHover",mt:2}}>This will replace your
                                        current diagram code.</Typography>
